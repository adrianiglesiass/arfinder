...
| 15 | Pendientes de auditoría frontend (re-auditar) | frontend | frontend-bugs | ⏳ EN CURSO |
| T | Arquitectura: router de conversaciones inflado, duplicación, capas | backend | architecture-cleanup | ⏳ pendiente |
...
3. ⏳ **fix/frontend-bugs** — hallazgos de la auditoría frontend. RAMA ACTUAL.
4. ⏳ **refactor/architecture-cleanup** — router de conversaciones, reutilización, capas.
5. ⏳ **feat/age-gender-filters**, **feat/available-from-filter**, **feat/favorites**, **feat/user-block**, **feat/reports**.

## Estado de la rama actual (fix/frontend-bugs)
- Base: `develop` (incluye #288 y #289).
- **Working tree con cambios locales del usuario SIN commitear** (NO tocar, NO commitear):
  `.github/workflows/frontend-ci.yml`, `frontend/src/app/app.config.ts`,
  `frontend/src/app/core/auth/auth.service.ts`,
  `frontend/src/app/core/interceptors/jwt-interceptor.ts`,
  `frontend/src/app/core/interceptors/retry-interceptor.ts`, `frontend/src/index.html`.
- Pendiente: re-auditar frontend (hallazgo #15), escribir specs y aplicar fixes.
